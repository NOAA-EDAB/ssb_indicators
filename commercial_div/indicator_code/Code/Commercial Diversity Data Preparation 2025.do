...
gen year = year(daten)
drop datestr daten
save "F:\ESRs\ESR2025\Data\diversitypplong", replace
...
#delimit ;
cd "U:\READ-SSB-Lee-spacepanels\data_folder\main";;

use "veslog_species_huge_2024_10_22.dta", clear;

#delimit ;
merge m:1 tripid using "just_one_area_2024_10_22.dta", keep(1 3);
rename _merge _merge1;

#delimit ;
merge m:1 tripid using "just_one_EPU_2024_10_22.dta", keep(1 3);
rename _merge _merge2;

#delimit ;
merge m:1 tripid myspp using "areas_tripids_species_2024_10_22.dta", keep(1 3);
rename _merge _merge3;

#delimit ;
merge m:1 tripid myspp using "EPUs_tripids_species_2024_10_22.dta", keep(1 3 4 5) update;
...
drop _merge*;
merge m:1 month year using "F:\ESRs\ESR2025\Data\diversitypplong";
	gen real_revenue = nrevenue*deflator;

drop if real_revenue == .;
drop if qtykept == 0;
	save "F:\ESRs\ESR2025\Data\SOE_diversityrevenuedata_2025", replace;
